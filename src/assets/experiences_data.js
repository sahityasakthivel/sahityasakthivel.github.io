...
const Experiences_Data = [
...

    {
        ...
        s_name:"JP Morgan",
        s_role:"Participant",
        s_time:"Oct 2022 - Oct 2022",
        s_title:"Code for Good allows students to brainstorm and develop MVP's in 24-hours to overcome challenges faced by NPO.",
        s_img: s4, 
        s_readmore: [
            "Collaborated within a team of five to develop a minimum viable product for Ignite Hubs.",
            "Analyzed and prioritized the organization’s key challenges, then brainstormed effective solutions.",
            "Worked alongside motivated peers to build a website that connects volunteers with various organizations."
        ],
        s_languages: ["Python", "Javascript", "React", "Team-working"],
